<?php
// BELANGRIJKE REGELS! VOOR ERRORS TE TONEN
...
// VOEG ITEM TOE IN DATABASE
function insertIntoDB(String $firstname, String $lastname, String $mail, String $password, int $optin): bool|int
{
    $db = connectToDB();
...
function isMailUnique(String $email): bool // CONTROLEERT OF MAIL AL BESTAAT IN DB
{
    $sql = "SELECT COUNT(*) AS total FROM users WHERE mail=:mail AND status=1";
